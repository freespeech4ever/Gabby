...
import com.freespeech4ever.gabby.fragment.TimelineFragment
import com.freespeech4ever.gabby.util.*
import com.freespeech4ever.gabby.viewmodel.ListsViewModel
import com.freespeech4ever.gabby.viewmodel.ListsViewModel.Event.*
import com.freespeech4ever.gabby.viewmodel.ListsViewModel.LoadingState.*
        ...
        when (state.loadingState) {
            ...
            LOADED ->
                if (state.lists.isEmpty()) {
                    messageView.show()
                    messageView.setup(R.drawable.ic_twemoji, R.string.message_empty,
                            null)
                } else {
                    messageView.hide()
                }
