...
package com.freespeech4ever.gabby.fragment;
...
import com.freespeech4ever.gabby.AccountListActivity;
import com.freespeech4ever.gabby.BaseActivity;
import com.freespeech4ever.gabby.R;
import com.freespeech4ever.gabby.adapter.StatusBaseViewHolder;
import com.freespeech4ever.gabby.adapter.TimelineAdapter;
import com.freespeech4ever.gabby.appstore.BlockEvent;
import com.freespeech4ever.gabby.appstore.EventHub;
import com.freespeech4ever.gabby.appstore.FavoriteEvent;
import com.freespeech4ever.gabby.appstore.MuteEvent;
import com.freespeech4ever.gabby.appstore.PreferenceChangedEvent;
import com.freespeech4ever.gabby.appstore.ReblogEvent;
import com.freespeech4ever.gabby.appstore.StatusComposedEvent;
import com.freespeech4ever.gabby.appstore.StatusDeletedEvent;
import com.freespeech4ever.gabby.appstore.UnfollowEvent;
import com.freespeech4ever.gabby.db.AccountManager;
import com.freespeech4ever.gabby.di.Injectable;
import com.freespeech4ever.gabby.entity.Filter;
import com.freespeech4ever.gabby.entity.Poll;
import com.freespeech4ever.gabby.entity.Status;
import com.freespeech4ever.gabby.interfaces.ActionButtonActivity;
import com.freespeech4ever.gabby.interfaces.RefreshableFragment;
import com.freespeech4ever.gabby.interfaces.ReselectableFragment;
import com.freespeech4ever.gabby.interfaces.StatusActionListener;
import com.freespeech4ever.gabby.network.MastodonApi;
import com.freespeech4ever.gabby.repository.Placeholder;
import com.freespeech4ever.gabby.repository.TimelineRepository;
import com.freespeech4ever.gabby.repository.TimelineRequestMode;
import com.freespeech4ever.gabby.util.Either;
import com.freespeech4ever.gabby.util.ListStatusAccessibilityDelegate;
import com.freespeech4ever.gabby.util.ListUtils;
import com.freespeech4ever.gabby.util.PairedList;
import com.freespeech4ever.gabby.util.StringUtils;
import com.freespeech4ever.gabby.util.ThemeUtils;
import com.freespeech4ever.gabby.util.ViewDataUtils;
import com.freespeech4ever.gabby.view.BackgroundMessageView;
import com.freespeech4ever.gabby.view.EndlessOnScrollListener;
import com.freespeech4ever.gabby.viewdata.StatusViewData;
...
public class TimelineFragment extends SFragment implements
    ...
    private void showNothing() {
        ...
        statusView.setup(R.drawable.ic_twemoji, R.string.message_empty, null);
    }
