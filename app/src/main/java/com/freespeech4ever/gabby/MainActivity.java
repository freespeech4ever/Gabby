...
import com.freespeech4ever.gabby.appstore.CacheUpdater;
import com.freespeech4ever.gabby.appstore.EventHub;
import com.freespeech4ever.gabby.appstore.MainTabsChangedEvent;
import com.freespeech4ever.gabby.appstore.ProfileEditedEvent;
import com.freespeech4ever.gabby.components.conversation.ConversationsRepository;
...
import com.freespeech4ever.gabby.pager.MainPagerAdapter;
import com.freespeech4ever.gabby.util.CustomEmojiHelper;
import com.freespeech4ever.gabby.util.NotificationHelper;
...
import static com.freespeech4ever.gabby.util.MediaUtilsKt.deleteStaleCachedMedia;
...
public final class MainActivity extends BottomSheetActivity implements ActionButtonActivity,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteStaleCachedMedia(getApplicationContext().getExternalFilesDir("Gabby"));
    }
