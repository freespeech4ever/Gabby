...
import com.freespeech4ever.gabby.adapter.AccountSelectionAdapter;
...
import com.freespeech4ever.gabby.interfaces.AccountSelectionListener;
import com.freespeech4ever.gabby.interfaces.PermissionRequester;
...
public abstract class BaseActivity extends AppCompatActivity implements Injectable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap appIcon = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_gabby_launcher);
