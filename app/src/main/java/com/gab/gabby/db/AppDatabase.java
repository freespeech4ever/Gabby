...
import com.gab.gabby.TabDataKt;
...
@Database(entities = {PostEntity.class, AccountEntity.class, InstanceEntity.class, TimelineStatusEntity.class,
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static final Migration MIGRATION_6_7 = new Migration(6, 7) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("CREATE TABLE IF NOT EXISTS `InstanceEntity` (`instance` TEXT NOT NULL, `emojiList` TEXT, `maximumPostCharacters` INTEGER, PRIMARY KEY(`instance`))");
    ...
    public static final Migration MIGRATION_8_9 = new Migration(8, 9) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE `PostEntity` ADD COLUMN `descriptions` TEXT DEFAULT '[]'");
        }
    };
