...
import com.gab.gabby.adapter.AccountFieldAdapter
...
import com.gab.gabby.pager.AccountPagerAdapter
...
class AccountActivity : BottomSheetActivity(), ActionButtonActivity, HasSupportFragmentInjector, LinkListener {
    ...
    private fun setupRefreshLayout() {
        ...
        swipeToRefreshLayout.setColorSchemeResources(R.color.gabby_blue)
