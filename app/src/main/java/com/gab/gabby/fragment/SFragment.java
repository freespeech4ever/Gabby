...
import com.gab.gabby.BottomSheetActivity;
import com.gab.gabby.ComposeActivity;
import com.gab.gabby.MainActivity;
import com.gab.gabby.R;
import com.gab.gabby.ReportActivity;
    ...
    private void showConfirmEditDialog(final String id, final int position, Status status) {
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok, (dialogInterface, i) -> {
                    ...
                    Intent intent = new ComposeActivity.IntentBuilder()
                            .postText(getEditableText(status.getContent(), status.getMentions()))
