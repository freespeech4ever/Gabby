...
class AboutActivity : BottomSheetActivity(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        versionTextView.text = getString(R.string.about_gabby_version, BuildConfig.VERSION_NAME)

        aboutLicenseInfoTextView.setClickableTextWithoutUnderlines(R.string.about_gabby_license)
        ...
        gabbyProfileButton.setOnClickListener {
    ...
    private fun onAccountButtonClick() {
        viewUrl("https://mastodon.social/@Gabby")
    }
