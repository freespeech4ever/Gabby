...
import com.gab.gabby.appstore.CacheUpdater;
import com.gab.gabby.appstore.EventHub;
import com.gab.gabby.appstore.MainTabsChangedEvent;
import com.gab.gabby.appstore.ProfileEditedEvent;
import com.gab.gabby.components.conversation.ConversationsRepository;
...
import com.gab.gabby.pager.MainPagerAdapter;
...
import static com.gab.gabby.util.MediaUtilsKt.deleteStaleCachedMedia;
...
public final class MainActivity extends BottomSheetActivity implements ActionButtonActivity,
    ...
    private static final long DRAWER_ITEM_SAVED_POST = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (ComposeActivity.canHandleMimeType(intent.getType())) {
                // Sharing to Gabby from an external app
                if (accountRequested) {
    ...
    private void setupDrawer() {
        ...
        listItems.add(new PrimaryDrawerItem().withIdentifier(DRAWER_ITEM_SAVED_POST).withName(R.string.action_access_saved_post).withSelectable(false).withIcon(R.drawable.ic_notebook).withIconTintingEnabled(true));
                ...
                .withOnDrawerItemClickListener((view, position, drawerItem) -> {
                    if (drawerItem != null) {
                        ...
                        if (drawerItemIdentifier == DRAWER_ITEM_EDIT_PROFILE) {
                            ...
                            Intent intent = new Intent(MainActivity.this, SavedPostActivity.class);
                            startActivityWithSlideInAnimation(intent);
