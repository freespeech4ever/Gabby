...
import com.gab.gabby.adapter.AccountSelectionAdapter;
import com.gab.gabby.db.AccountEntity;
import com.gab.gabby.db.AccountManager;
import com.gab.gabby.di.Injectable;
import com.gab.gabby.interfaces.AccountSelectionListener;
import com.gab.gabby.interfaces.PermissionRequester;
...
public abstract class BaseActivity extends AppCompatActivity implements Injectable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (theme.equals("black")) {
            setTheme(R.style.GabbyBlackTheme);
        }
    ...
    protected void attachBaseContext(Context base) {
        super.attachBaseContext(GabbyApplication.localeManager.setLocale(base));
    }
