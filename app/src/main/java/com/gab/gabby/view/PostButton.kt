...
@JvmOverloads constructor(
    ...
    private val smallStyle: Boolean = context.resources.getBoolean(R.bool.show_small_post_button)
    ...
    init {
        ...
        val padding = resources.getDimensionPixelSize(R.dimen.post_button_horizontal_padding)
